...
public class TaskTest {
	...
	public void testValidTask() {
		...
		Assertions.assertTrue(Validator.taskName("Taskplay"));
	...
	public void testValidpriority() {
		...
		Assertions.assertTrue(Validator.taskPriority(5));
